  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" height="550" borderstyle="width:100%">
        ...
        <el-table-column prop="real" label="真实姓名" width="200"></el-table-column>
        ...
        <el-table-column width="100" label="操作" v-if="pos!=2">
        ...
        <el-table-column fixed="right" width="100" v-else>
        </el-table-column>

        <el-table-column fixed="right" width="1" label="">
          <template #default="scope">
            <div v-if="pos<scope.row.pos&&isOperate==scope.$index" class="op">
              <div v-if="pos==0">
                <div v-if="scope.row.pos==1" @click="cancel">
                  取消管理员
                </div>
                <div v-else @click="set">设置管理员</div>
              </div>
              <div @click="kick">移出团队</div>
            </div>
