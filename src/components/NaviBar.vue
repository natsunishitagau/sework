<template>
  ...
  <div class="naviBar">
    ...
    <div class="avatar">
      <img :src="avatorSrc" @mouseenter="LookIn" @mouseleave="LookOut" :style="imgSize"/>
    </div>
    <div class="info" @mouseenter="LookIn" @mouseleave="LookOut" v-show="isLookInfo">
      <div v-if="isLogin" class="userInfo">
        <div>{{userName}}</div>
        <div><svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-v-78e17ca8=""><path fill="currentColor" d="M512 128 128 447.936V896h255.936V640H640v256h255.936V447.936z"></path></svg>
          &nbsp;&nbsp;个人中心
