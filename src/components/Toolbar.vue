<template>
    <div>
        <div class="toolbar">
            <el-button @click="undo" icon="el-icon-refresh-left">撤消</el-button>
            <el-button @click="redo" icon="el-icon-refresh-right">重做</el-button>
            <label for="input" class="insert"><i class="el-icon-picture-outline"></i> 插入图片</label>
            <input
                id="input"
                type="file"
                hidden
            ...
            <el-button style="margin-left: 10px;" @click="preview" icon="el-icon-view">预览</el-button>
            ...
            <el-button :disabled="!areaData.components.length" @click="compose" style="margin-left: 50px;">组合</el-button>
            <el-button
...
export default {
    ...
    methods: {
        ...
        save() {
            this.$axios.post('http://81.70.16.241/back/project/savePrototype/ ', this.$qs.stringify({
                projectID: 2,
                canvasData: JSON.stringify(this.componentData),
...
.logo { margin-right: 125px;margin-left: 10px; }
.toolbar {
    padding: 15px 10px;
    white-space: nowrap;
    overflow-x: auto;
