...
export default {
    ...
    methods:{
        ...
        createPrototype(){
            const that = this
            that.componentData = that.defaultComponentData
            that.canvasStyleData = that.defaultCanvasData
            that.canvasStyleData.width=that.insertData.canvasWidth
            that.canvasStyleData.height=that.insertData.canvasHeight
            if(that.insertData.protoName.length!==0){
                this.$axios.post('/project/createPrototype/',this.$qs.stringify({
                    ...
                    canvasData:JSON.stringify(that.componentData),
                    canvasStyle:JSON.stringify(that.canvasStyleData),
